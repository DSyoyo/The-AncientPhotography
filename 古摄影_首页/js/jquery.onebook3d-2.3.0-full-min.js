  ...
  t.onebook = function (e, i, s) {
    ...
    var n = {
      init: function (e, i, s) {
        ...
        var t = this.CFG.ICONS_PANEL, e = t[this.PANEL_TYPE].height, i = t[this.PANEL_TYPE].noTitle, s = t.titleSection;
        ...
        var e = this, i = this.CFG.ICONS_PANEL, s = (this.STAGE, this.CFG.BOOK_SIZE, this.divNames.book_icons_panel),
          a = this.divNames.icons_container, n = this.divNames.book_spread_title, o = this.DARK_MODE ? "" : " light",
          h = {
            build: function () {
              if (e.NO_ONE_TITLES) {
                var s = i[r].noTitle;
          ...
          l = ['<div class="btn_image" style="width:' + d + "px;height:" + d + 'px;">', '<img src="' + this.GIF + '"></div>', "</div>"].join("");
        {
          var g = function () {
            ...
            E = f.clone(), S = E.find(".btn_image").css({background: c, opacity: A("end")}).attr({title: p.lngTitle});
        ...
        a.size() && a.remove(), this.ZOOMSIZE = {height: t(window).height(), width: t(window).width(), top: 0, left: 0};
        var n = this.ZOOMSIZE;
        ...
        var r = {
          buildZoomLayer: function () {
            ...
            i.$gZoomLayer.animate({top: n.top, left: n.left, width: s, height: a, opacity: 1}, 200, function () {
              t(this).css({
                opacity: 0,
                border: "0px none",
                background: "#e5e5e5"
        ...
        var e = this, t = t, i = this.getTotalSheets(), s = this.CURRENT.spread, a = 0 == s, n = s == i,
          o = this.ZOOMSIZE, h = 250, r = 85, d = {width: o.width, height: o.height - r, left: o.left, top: o.top},
          l = a || n ? 1 : 2, g = {height: this.CFG.BOOK_UNSCALED.height, width: this.CFG.BOOK_UNSCALED.width * l},
          A = g.width < d.width && g.height < d.height,
          p = {vertical: (g.height + 2 * h - d.height) / 100, horizontal: (g.width + 2 * h - d.width) / 100}, c = "",
          f = this.divNames.zoom_content, E = this.divNames.zoom_behavior_section, S = this.divNames.zoom_title_spread,
          u = this.divNames.zoom_buttons,
          ...
          T = (this.$gZoomLayer.find("." + S).css({height: r}), this.$gZoomLayer.find("." + u)), O = {
            buttonsInsert: function () {
              ...
              e.TMR_ZOOMPAGES_ANI = setTimeout(function () {
                i++;
                var e = i / t, n = 1 - (1 - Math.sin(Math.acos(1 - e))), o = 100 * n, h = s[1] - (s[1] - a[1]) / 100 * o,
                  r = s[0] - (s[0] - a[0]) / 100 * o;
        ...
        var l = {width: 800, height: Math.round(800 * i.height / i.width)}, g = this.FRAMES[0][0].bezie.length,
          A = Math.abs(this.FRAMES[0][0].bezie[g - 1].x), p = i.width / A, c = l.width / A, f = function (t, e) {
          ...
          n = {width: 300, height: 200}, o = this.DARK_MODE ? "dark" : "light", h = window[a].SKIN, r = {
            PlainTextured: function (t) {
              var e = "data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==",
                s = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7", a = t.src || e,
                n = THREE.FrontSide, h = t.skin,
        ...
        if (this.BOOK_INTERNAL) {
          var t = this.$TARGET, e = {top: 0, left: t.offset().left, width: t.width(), height: 100}, i = this.TARGETSIZE;
        ...
        if (this.GLOSSY) var i = this.getSheetByIndex(e), s = this.getEdgesFormSheet(e),
          ...
          var o = this.getSheetByIndex(e), h = this.getEdgesFormSheet(e), a = "front" == this.startDrag ? 1 : 0,
            n = {sheet: e, $edges: h, forward: a};
        ...
        try {
          var i = t.y - this.STAGE_CENTER.top, s = Math.abs(i), a = t.x - this.STAGE_CENTER.left,
            n = this.STAGE_HALF.width - this.CFG.BOOK_SIZE.width, o = this.CFG.BOOK_SIZE.width + Math.floor(.8 * n),
            h = this.STAGE_HALF.width - o, r = h / 100, d = Math.abs(a), l = {
        ...
        if (this.isDirectionCorrect(t)) {
          var e = this, i = "next" === t ? this.CURRENT.spread : this.CURRENT.spread - 1, s = "next" === t ? 1 : 0,
            a = function () {
          ...
          var f = 0 === this.CURRENT.spread & s, E = 1 === this.CURRENT.spread & !s, S = this.CURRENT.spread === l & !s,
            u = this.CURRENT.spread === l - 1 & s;
        ...
        if (this.LAST.forward = s, this.LAST.moved.forward = s ? 0 : 1, e.GLOSSY) {
          ...
          var n = s ? 180 : 0, h = this.getSheetByIndex(i), r = h.find(".wholeimage"), d = h.find(".all_edges");
        ...
        if (this.GLOSSY) {
          var e = t > 0 ? this.GL_ARR_SHEETS[t - 1] : !1, i = t < this.ALLSHEETS.length ? this.GL_ARR_SHEETS[t] : !1;
          if (e) {
            var s = e.backFilled;
            if (!s) return !1
          }
        ...
        var e = this, i = this.CFG.BOOK_SIZE, s = this.getLNG("hlpGoToHomelink"), n = this.getLNG("hlpClickToOpen"),
          o = this.getLNG("hlpUseMousewheel"), h = this.getLNG("toStart"),
          r = i.width < 150 ? 'class="middleSize"' : "", d = i.height < 130, l = this.DARK_MODE ? "dark" : "light",
          g = window[a].SKIN, A = [];
        ...
        var e = this, i = {
            ...
            PlainTextured: function (t) {
              var e = "data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==",
                i = t.imageSrc || e, s = (t.color ? t.color : 16777215, t.backSide ? THREE.BackSide : THREE.FrontSide),
            ...
            if (!e.SHEETS_WAS_BUILT[t]) {
              ...
              var i = t === l || t > l, a = i ? "sideRight" : "sideLeft", n = i ? "right" : "left",
                o = -1 * f[n] * e.CFG.GL_DEPTH_STEP, h = {num: t, sideClass: a, zindex3d: o, mesh: new THREE.Object3D},
          ...
          }, o = 1.2, h = this.LAST.forward, r = (this.GIF, this.CFG.NUMBEROF_PRELOAD_SHEETS), d = this.ALLSHEETS.length,
          l = this.CURRENT.spread, g = l == d, A = l - r, p = l + r;
        ...
        if (n.width > c || n.height > f) var E = c / n.width, S = f / n.height, u = Math.min(E, S), R = E == u,
          m = R ? c : Math.floor(n.width * u), v = R ? Math.floor(n.height * u) : f; else var m = n.width, v = n.height;
            ...
            switchSheetLoadingStatus: function () {
              ...
              if (i.GLOSSY) {
                ...
                v.css({background: "url(" + e.toDataURL() + ") " + T + "px 0px no-repeat"}), m.css({background: "url(" + e.toDataURL() + ") 0px 0px no-repeat"}), _.each(function (e) {
                  t(this).css({background: "url(" + n[e].src + ") no-repeat", backgroundSize: "100% 100%"})
                })
              }
            }
        ...
        }, a = 0 == this.CURRENT.spread, n = this.CURRENT.spread == this.getTotalSheets(), o = this.ARR_PAGES_SRC;
      ...
      init: function (t) {
        ...
        t(this.ARR_ANI).find(".book").each(function () {
          var s = [], a = t(this).attr("name"), n = t(this).find(".points").attr("xy").split(" ").map(function (t) {
          ...
          t(this).find(".frame").each(function () {
            for (var e = parseInt(t(this).attr("fr"), 10), i = t(this).attr("ang").split(" ").map(function (t) {
              return parseInt(t)
            }), a = {frame: e, line: []}, o = 0; o < n.length; o++) a.line[o] = {xy: n[o], ang: i[o], center: [0, 0]};
            s.push(a)
        ...
        return t.each(e, function (t) {
          if (!(t < i.FIRST_KEYFRAME)) for (var e = this.line, t = 0; t < e.length; t++) {
            var s = e[t].ang, a = s > 0 ? 1 : -1, n = s * a, o = e[t].center,
              h = [i.MATH.COS[n], a * -i.MATH.SIN[n], o[0], a * i.MATH.SIN[n], i.MATH.COS[n], o[1]], r = e[t].xy,
              d = i.MATH.xy_matrix2d(r, h);
